...
var request = __webpack_require__(5),
    statusBat = __webpack_require__(12),
    userData = __webpack_require__(13),
    goToBack = __webpack_require__(19),
    cookie = __webpack_require__(11),
    userPage = __webpack_require__(20),
    urlController = __webpack_require__(4),
    checkDevise = __webpack_require__(14),
    _require = __webpack_require__(0),
...
if (store.token === null) {
    ...
    store.request.sendRequest(METHOD_GET_USER, {}, function (error, data) {
        ...
        var id = urlController.getParam("id=");
        if (!id) {
...
var goToBack = function goToBack() {
    ...
    _classCallCheck(this, goToBack);

    document.getElementById("go-to-back").onclick = function () {
        history.back();
    };
    ...
    this.input.onkeydown = function (e) {
        if (e.keyCode === 13) {
            urlController.goToMainPage(_this.input.value);
        }
    };
};
...
var userPage = function () {
    ...
    _createClass(userPage, [{
        ...
        key: "createCountersText",
        value: function createCountersText(name, count) {
            if (count === undefined) return name + ": СКРЫТО";
            return name + ": " + count;
        }
    }, {
        key: "setDataSameElements",
        value: function setDataSameElements(element, data) {
